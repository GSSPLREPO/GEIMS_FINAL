                    ...
                    <div id="tabs-1" style="height: 643px; padding: 5px 5px 5px 5px;" class="gradientBoxesWithOuterShadows">
                        ...
                        <div style="width: 100%;">
                            ...
                            <div class="divclasswithfloat">
                                ...
                                <div style="text-align: left; float: right; width: 30%;">
                                    <asp:DropDownList ID="ddlDivisionName" runat="server" CssClass=" validate[required] Droptextarea" Width="260px" Enabled="true" OnSelectedIndexChanged="ddlDivisionName_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
